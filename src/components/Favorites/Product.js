        ...
        <View style={styles.product}>
            ...
            <View style={styles.info}>
                ...
                <View style={styles.btnContainer}>
                    <Button mode="contained" color={colors.primary} onPress={() => goToProduct(item.product._id)}>Ver producto</Button>
                    <IconButton style={styles.btnDelete} icon="close" color="#fff" size={16} onPress={() => deleteFavorite(item.product._id)} />
                </View>
            </View>
            {loading && (
