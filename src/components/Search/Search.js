    ...
    return(
      <View style={styles.container} onLayout={(e) => setContainerHeight(e.nativeEvent.layout.height)}>
        ...
        <View style={styles.containerInput}>
            <AnimatedIcon name="arrow-left" size={20}  style={[styles.backArrow, arrowAnimation]} onPress={closeSearch} />

            <Animated.View style={[inputAnimation, {width: inputAnimationWidth}]}>
                <Searchbar placeholder="Busca tu producto..." onFocus={openSearch} value={searchQuery} onChangeText={onChangeSearch} onSubmitEditing={onSearch} />
            </Animated.View>
